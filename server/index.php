...
$dsn = 'mysql://root:root@localhost/jars/';
$clients = [];
/**
 * The MIT License
...
ArrestDB::Serve('GET', '/(#any)/(#any)/(#any)',
...

{
	...
	function Serve($on = null, $route = null, $callback = null)
	{
			static $root = null;
